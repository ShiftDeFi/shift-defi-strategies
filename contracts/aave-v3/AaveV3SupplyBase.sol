...
/// @notice Shared Aave V3 supply logic. Concrete strategies only need to implement `_harvest` -
///         everything else (state machine, enter/exit, NAV) is identical regardless of how rewards
///         are harvested.
abstract contract AaveV3SupplyBase is StrategyTemplate, IAaveV3Supply {
